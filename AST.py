...
"work in progress"...
Notamment, l'utilisation de pydot pour repr�nter un arbre syntaxique cousu
...
class Node:
    ...
    def threadTree(self, graph, seen = None, col=0):
            ...
            for i,c in enumerate(self.next):
                ...
                # Les arr�s correspondant aux coutures ne sont pas prises en compte
...
def addToClass(cls):
    ...
    Permet d'impl�menter une forme �m�mentaire de programmation orient�e
